...
# 입찰 공고사이트에 대한 키이다.
xmlUrl = 'http://apis.data.go.kr/1230000/BidPublicInfoService05/getBidPblancListInfoServcPPSSrch02'
...
if len(resultList) == 0:
    ...
    #            'bidntcedt':'입찰공고일시','bidqlfctrgstdt':'입찰참가자격등록마감일시','bidclsedt':'입찰마감일시','asignbdgtamt':'사업금액',
    ...
    columns = {'bidntceno': '입찰공고번호', 'ntcekindnm': '공고종류명',
               'bidntcedt': '입찰공고일시', 'bidqlfctrgstdt': '입찰참가자격등록마감일시', 'bidclsedt': '입찰마감일시', 'asignbdgtamt': '사업금액',
               'opengdt': '개찰일시', 'bidntcenm': '입찰공고명', 'bidmethdnm': '입찰방식명', 'cntrctcnclsmthdnm': '계약체결방법명',
               'dminsttnm': '수요기관','bidntcedtlurl': '입찰공고상세url','sucsfbidmthdnm': '낙찰방법명', 'infobizyn': '정보화사업',
               'bidprtcptlmtyn': '입찰참가제한여부'}
    ...
    sp.SU_MO_To_excel(gresult, "C:\\work\\"+fname+"_공고현황.xlsx")
