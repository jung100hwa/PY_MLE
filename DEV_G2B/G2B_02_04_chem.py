...
# 변수선언
# 수정 : 5월 27일(조달청에서 이렇게 바꾸라네) -> 즉8월쯤에는 아래와 같이 바꿔야 겠네
# 그리고 다시한번 활용신청을 해야 된다네..번거롭다.
        ...
        queryParams = '?' + urlencode(
            {
                ...
                # quote_plus('bidNtceNm') : biznm,              # 공고명
...
if len(gdf) == 0:
    ...
    strQ = "bidntcenm.str.contains('화학|생활화학제품|살생|독성', regex=True)"
    result = gdf.query(strQ)
    ...
    columns = {'bidntceno':'공고번호','ntcekindnm':'공고종류명','asignbdgtamt':'사업금액', 'bidclsedt':'입찰마감일시','bidntcenm':'사업명','dminsttnm':'수요기관'}
    ...
    SU_Pandas_MO.SU_MO_To_excel(result, "C:\\work\\03.제안작성\\"+fname+"_화학관련.xlsx")
